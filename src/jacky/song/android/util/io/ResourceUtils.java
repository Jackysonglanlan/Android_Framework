...
import jacky.song.android.util.lang.StringUtils;
import jacky.song.android.util.ref.ClassUtils;
...
public abstract class ResourceUtils {
	...
	public static URL buildURL(String spec) {
		...
		try {
			if (isFile) {
				final File file = new File(spec.substring(5));
				return adjustTrailingSlash(file.toURI().toURL(), file.isDirectory());
			}
			return new URL(spec);
		}
		catch (MalformedURLException e) {
