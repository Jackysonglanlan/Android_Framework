/*
 * Copyright 2002-2007 the original author or authors. Licensed under the Apache License, Version 2.0 (the "License");
...
public abstract class Assert {
   ...
   private static boolean strHasLength(CharSequence str) {
   ...
   private static boolean strHasText(CharSequence str) {
      if (!strHasLength(str)) {
         return false;
      }
   ...
   /**
    * Assert that the given String has valid text content; that is, it must not be <code>null</code> and must contain at
   ...
   public static void doesNotContain(String textToSearch, String substring, String message) {
      if (strHasLength(textToSearch) && strHasLength(substring)
