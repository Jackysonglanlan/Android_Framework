...
public abstract class StringUtils {
	...
	/**
	 * @param stripChars
	 *          if null, remove leading unicode whitespaces.
	 */
	...
	public static CharSequence stripStart(CharSequence src, String stripChars) {
		int srclen;
		if (src == null || (srclen = src.length()) == 0) { return src; }
		int start = 0;
		if (stripChars == null) {
	...
	public static CharSequence stripEnd(CharSequence src, String stripChars) {
		int end;
		if (src == null || (end = src.length()) == 0) { return src; }
		if (stripChars == null) {
	 ...
	 * 
	 * @link
	 *       http://jakarta.apache.org/commons/lang/apidocs/org/apache/commons/lang/math/NumberUtils.html
	 */
	...
	public static Locale parseLocaleString(String localeString) {
		...
		String variant = "";
		if (parts.length >= 2) {
			// There is definitely a variant, and it is everything after the nation
			// code sans the separator between the nation code and the variant.
